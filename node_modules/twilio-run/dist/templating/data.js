...
const TEMPLATES_URL = 'https://raw.githubusercontent.com/twilio-labs/function-templates/master/templates.json';
const CONTENT_BASE_URL = 'https://api.github.com/repos/twilio-labs/function-templates/contents';
function fetchListOfTemplates() {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield got_1.default(TEMPLATES_URL, { json: true });
...
function getFiles(templateId, directory) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield got_1.default(CONTENT_BASE_URL + `/${templateId}/${directory}`, {
            json: true,
            headers,
        });
...
function getTemplateFiles(templateId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const headers = buildHeader();
            const response = yield got_1.default(CONTENT_BASE_URL + `/${templateId}`, {
                json: true,
                headers,
            });
            const repoContents = response.body;
